...
- The current hour always shows its temperature in the dial, even when its weather changes. The current hour’s temperature is highlighted on color watches. Its weather icon sits at the hour-hand tip, following the hand through its launch animation too.
